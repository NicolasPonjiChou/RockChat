...
;(function (global, factory) {
   ...
   factory(global.moment)
    ...
    function translate(number, withoutSuffix, key) {
        ...
        switch (key) {
            case 'm':
                return withoutSuffix ? 'minuta' : 'minut臀';
            case 'mm':
                return result + (plural(number) ? 'minuty' : 'minut');
            case 'h':
                return withoutSuffix  ? 'godzina'  : 'godzin臀';
            case 'hh':
                return result + (plural(number) ? 'godziny' : 'godzin');
            case 'MM':
                return result + (plural(number) ? 'miesi膮ce' : 'miesi臀cy');
            case 'yy':
    ...
    var pl = moment.defineLocale('pl', {
        ...
        weekdaysMin : 'Nd_Pn_Wt_檣r_Cz_Pt_So'.split('_'),
        longDateFormat : {
            LT : 'HH:mm',
            LTS : 'HH:mm:ss',
            L : 'DD.MM.YYYY',
        ...
        calendar : {
            ...
            lastWeek: function () {
                switch (this.day()) {
                    case 0:
                        return '[W zesz艂膮 niedziel臀 o] LT';
                    case 3:
                        return '[W zesz艂膮 艣rod臀 o] LT';
                    case 6:
                        return '[W zesz艂膮 sobot臀 o] LT';
                    default:
