...
//! locale : Slovenian [sl]
//! author : Robert Sedov擰ek : https://github.com/sedovsek
    ...
    var sl = moment.defineLocale('sl', {
        ...
        calendar : {
            ...
            lastWeek : function () {
                switch (this.day()) {
                    case 0:
                        return '[prej擰njo] [nedeljo] [ob] LT';
                    case 3:
                        return '[prej擰njo] [sredo] [ob] LT';
                    case 6:
                        return '[prej擰njo] [soboto] [ob] LT';
                    case 1:
                    case 2:
                    case 4:
                    case 5:
                        return '[prej擰nji] dddd [ob] LT';
                }
            },
            sameElse : 'L'
        },
